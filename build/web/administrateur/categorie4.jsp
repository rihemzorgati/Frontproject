            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Catégorie 4</li>
                </ol>
              </nav>
            </div>
                  <div class="row">                   
                ...
                <div class="card bg-gradient-k card-img-holder text-white">           
                    <img src="assets/images/categorie4/refrigerateur.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Réfrigérateur </span> </h6>              
                </div>
              </div>  
                   
                <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-p card-img-holder text-white">           
                    <img src="assets/images/categorie4/m_a_laver.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"></span> M à laver <br/><span class="marge"> automatique </span> </h6>              
                </div>
              </div>
                   
               <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-m card-img-holder text-white">           
                    <img src="assets/images/categorie4/pc.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge">  PC </span> </h6>              
                </div>
              </div>
                   
                    <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-m card-img-holder text-white">           
                    <img src="assets/images/categorie4/climatiseur.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge">  Climatiseur </span> </h6>              
                </div>
              </div>
                                      
                    <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-k card-img-holder text-white">           
                    <img src="assets/images/categorie4/living.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Living </span>  </h6>              
                </div>
              </div>
                   
                    <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-p card-img-holder text-white">           
                    <img src="assets/images/categorie4/ldc.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> LDC </span>  </h6>              
                </div>
              </div>
