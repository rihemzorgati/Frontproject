    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <div class="content-wrapper">
			...
			try{
			    connexionController conn1 = new connexionController();
			       ...
			       String req1 ="select * from proposition p, utilisateur u where u.Matricule=p.Matricule ";
		...
		<table>    
                    <tr>
                        <td>
				 <label> <%=res.getString("proposition")%> </label> 
			</td>
			
			<td>
			   <a class="nav-link dropdown-toggle" href="#" id="yummyDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Détails</a>
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                       <label> Matrciule : <%=res.getString("matricule")%> </label> 
				       <br>
				        <label> Nom : <%=res.getString("nom")%> </label>
					<label> Prénom : <%=res.getString("prenom")%> </label>
                                    </div>
