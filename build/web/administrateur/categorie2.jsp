            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Catégorie 2</li>
                </ol>
              </nav>
            </div>
                              <div class="row">                   
                <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-d card-img-holder text-white">           
                    <img src="assets/images/categorie2/aspirateur.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Aspirateur </span> </h6>              
                </div>
                </div>  
                   
                   <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-h card-img-holder text-white">           
                    <img src="assets/images/categorie2/chauffage.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Chauffage </span> </h6>              
                </div>
                </div> 
                   
                   <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-r card-img-holder text-white">           
                    <img src="assets/images/categorie2/robot_de_cuisine.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Robot de cuisine </span> </h6>              
                </div>
                </div> 
                   
                      <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-r card-img-holder text-white">           
                    <img src="assets/images/categorie2/recepteur_hd.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Recepteur HD</span> </h6>              
                </div>
                </div> 
                   
                    <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-d card-img-holder text-white">           
                    <img src="assets/images/categorie2/bicyclette.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Bicyclette </span> </h6>              
                </div>
                </div>
                   
                    <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-h card-img-holder text-white">           
                    <img src="assets/images/categorie2/gsm.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> GSM </span> </h6>              
                </div>
                </div>
