            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Catégorie 3</li>
                </ol>
              </nav>
            </div>
               <div class="row">                   
                <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-v card-img-holder text-white">           
                    <img src="assets/images/categorie3/hautte.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Hautte </span> </h6>              
                </div>
              </div>  
                   
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-j card-img-holder text-white">           
                    <img src="assets/images/categorie3/machine_a_laver.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Machine à laver </span> </h6>              
                </div>
              </div> 
                   
             <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-b card-img-holder text-white">           
                    <img src="assets/images/categorie3/tablette.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Tablette </span> </h6>              
                </div>
              </div>     
            
                    <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-b card-img-holder text-white">           
                    <img src="assets/images/categorie3/cuisiniere.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Cuisinière </span> </h6>              
                </div>
              </div>
                   
                   <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-v card-img-holder text-white">           
                    <img src="assets/images/categorie3/chauffe_bain.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Chauffe bain </span> </h6>              
                </div>
              </div>
                   
                <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-j card-img-holder text-white">           
                    <img src="assets/images/categorie3/apn.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> APN </span> </h6>              
                </div>
              </div> 
