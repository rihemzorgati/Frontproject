            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Catégorie 5</li>
                </ol>
              </nav>
            </div>
               <div class="row">
                ...
                <div class="card bg-gradient-lm card-img-holder text-white">           
                    <img src="assets/images/categorie5/salle_a_manger.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Salle à manger </span> </h6>              
                </div>
              </div>
                   
                   <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-ll card-img-holder text-white">           
                    <img src="assets/images/categorie5/voyage.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"><span class="marge"><span class="marge"> Voyage </span> </h6>              
                </div>
                </div>
                       
                <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-l card-img-holder text-white">           
                    <img src="assets/images/categorie5/salle_de_bain.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Salle de bain </span> </h6>              
                </div>
                </div>
                       
               <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-l card-img-holder text-white">           
                    <img src="assets/images/categorie5/chambre_enfant.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"> Chambre d'enfant </span> </h6>              
                </div>
                </div>
                   
                      <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-lm card-img-holder text-white">           
                    <img src="assets/images/categorie5/salon.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"><span class="marge"><span class="marge"> Salon </span> </h6>              
                </div>
              </div>
                   
                 <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-ll card-img-holder text-white">           
                    <img src="assets/images/categorie5/scooter.jpg" class="card-img-absolute" alt="circle-image" />                 
                    <h3 class="mb-5"> <br/><br/>  <span class="marge"></span></h3>
                    <h6> <br/><br/> <span class="marge"><span class="marge"><span class="marge"> Scooter </span> </h6>              
                </div>
                </div>
